...
const Home = () => {
  return (
    ...
    <div class="items-center justify-center text-center">
      ...
      <h1 class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-slate-900 sm:text-7xl">Share your <br />AI prompt
      ...
      <p class="desc text-center">If you're interested in learning more about AI prompt ideas, or if you're just looking for a place to share your own ideas, then the AI Prompt Ideas Community is the perfect place for you.</p>
