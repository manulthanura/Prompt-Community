...
const Home = () => {
  return (
    ...
    <div class="items-center justify-center text-center">
      ...
      <h1 class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-slate-900 sm:text-7xl">Share your<br />AI prompt <br className="max-md:hidden"/>
